                        ...
                        <div className="ab-infor-item__inner">
                            ...
                            <div className="ab-infor-item__content">
                                ...
                                <div className="ab-infor-item__right-desc">
                                    <h4 className="ab-infor-item__right-title">{item.title}</h4>
                                    ...
                                    <table className='ab-infor-item__right-table'>
                                        <tr className='ab-infor-item__right-tr'>
                                            ...
                                            <div>
                                                <td className='ab-infor-item__right-item-text'>{item.categor}</td>
                                            </div>
                                        </tr>
                                        <tr className='ab-infor-item__right-tr'>
                                            <div>
                                        ...
                                        <tr className='ab-infor-item__right-tr'>
                                            ...
                                            <div>
                                                <td className='ab-infor-item__right-item-text'>{item.number}</td>
                                            </div>
                                        </tr>
                                    </table>
